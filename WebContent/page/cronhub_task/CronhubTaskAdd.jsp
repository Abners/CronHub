...
<body>
	<div class="tab">
		<a class="tab-selected"><img src="<%=basePath %>res/icons/16x16/application_side_list.png" />新增调度任务</a>
	</div>
	<form id="formTaskAdd" name="formCronhubTaskAdd" action="<%=basePath %>task/task_add_form_submit.action" method="post">
		...
		<tr id="daemonIdTR" style="display:none">
			...
			<td>
				...
				<b>*</b>
				<a><img src="<%=basePath %>res/icons/16x16/table_go.png"/></a>
