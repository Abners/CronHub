...
<body>
	<div class="tab">
		<a class="tab-selected"><img src="<%=basePath %>res/icons/16x16/application_side_list.png" />task任务列表</a>
	</div>
	<div class="toolbar">
		...
		<input id="txtShellCmd" valid="validationCmd" invalid_msg="请输入命令.." type="text" stat="like" trigger="click" trigger_target="btnShellCmd"  name="filter_state_shell_cmd" value="请输入命令..." class="input-shorttext" onclick="if('请输入命令...' == $(this).val()){$(this).val('');}"/><a id="btnShellCmd"><img src="<%=basePath %>res/icons/16x16/application_form_magnify.png" />按照命令过滤</a>
		<!-- <a onclick="doBatch('data/common/doBatch.jsp', '确定要删除task任务吗？');"><img src="<%=basePath %>res/icons/16x16/cancel.png" />删除</a> -->		
	</div>
	<table class="grid">
		<thead>
			<tr>
				...
				<th><span><select name="filter_state_run_mode" trigger="change" stat="equal" trigger_target="this"><option value="-1">模式</option><option  value="1">主动</option><option value="0">被动</option></select><img src="<%=basePath %>res/icons/16x16/magnifier.png"/></span></th>
		...
		<tbody>
			...
			<tr id="<s:property value='#taskbean.id' />">
				...
				<td align="center"><span><img title="<s:property value='#taskbean.id' />" name="status" src="<%=basePath %>res/icons/16x16/picture_empty.png"/></span></td>
