...
<body>
	...
	<div class="toolbar">
		...
		<a id="btnKill"><img src="<%=basePath %>res/icons/16x16/kill_application_osx_terminal.png" />杀死</a>
		<a onclick="doBatch('data/common/doBatch.jsp', '确定要删除选中的用户吗？');"><img src="<%=basePath %>res/icons/16x16/application_osx_terminal.png" />杀死并重新执行</a>
		...
		<!-- <a id="returnStr"><img src="<%=basePath %>res/icons/16x16/script.png" />运行返回结果字符串</a> -->
	</div>
	<table class="grid">
		<thead>
			<tr>
		...
		<s:iterator value="#request.beanlist" id="recordbean" status="stat">
			<tr id="<s:property value='#recordbean.id' />">
				...
				<td align="center"><span><img src="<%=basePath %>res/icons/16x16/hourglass.png"/></span></td>
